				...
				playlists: function(res){
					if(res && res.items.length > 0){
						...
						for(i=0; i<playlists.length; i++){
							...
							list += '<a href="https://www.youtube.com/channel/UCjZKpZnWt6uKowt7efFO1iQ/" data-ytv-playlist="'+(data.plid)+'">'; //was list += '<a href="#" data-ytv-playlist="'+(data.plid)+'">';
						...
						headerLink.href="https://www.youtube.com/channel/UCjZKpZnWt6uKowt7efFO1iQ/"; //was #
						...
						utils.ajax.get( utils.endpoints.userInfo(), function(userInfo){
							...
							list += '<div class="ytv-list-header">';
								list += '<a href="'+(user.url)+'" target="_blank">'; 
									...
									list += '<span>'+'Посмотреть ещё на нашем youtube канале'+'</span>'; // was list += '<span>'+(user.title)+'</span>'
								list += '</a>';
							list += '</div>';
